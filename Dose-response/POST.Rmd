...
dicambamodel2 <- drm(Biomass_Red.*100 ~ Rate, fct=l3(fixed =c(NA,NA,NA), names = c("slope", "upper", "ed50")), data=dicamba)
...
plot(dicambamodel2, type="confidence", col=c(1,2), xlab="g ae/ha",#log="", 
     legendPos=c(3.5,50))
ED(dicambamodel, c(10, 50, 90), type="absolute", interval ="delta")
```
...
clopyralidmodel <- drm(Biomass_Red.*100 ~ Rate, Cultivar, fct=l3(fixed =c(NA,40,NA), names = c("slope", "upper", "ed50")), data=clopyralid)
clopyralidmodel2 <- drm(Biomass_Red.*100 ~ Rate, fct=l3(fixed =c(NA,40,NA), names = c("slope", "upper", "ed50")), data=clopyralid)
...
twofourDmodel <- drm(Biomass_Red.*100 ~ Rate, Cultivar, fct=l3(fixed =c(NA,NA,NA), names = c("slope", "upper", "ed50")), data=twofourD)
twofourDmodel2 <- drm(Biomass_Red.*100 ~ Rate, fct=l3(fixed =c(NA,NA,NA), names = c("slope", "upper", "ed50")), data=twofourD)
...
POSTrimmodel <- drm(Biomass_Red.*100 ~ Rate, Cultivar, fct=l3(fixed =c(NA,NA,NA), names = c("slope", "upper", "ed50")), data=POSTrim)
POSTrimmodel2 <- drm(Biomass_Red.*100 ~ Rate, fct=l3(fixed =c(NA,NA,NA), names = c("slope", "upper", "ed50")), data=POSTrim)
...
POSTchlorethylmodel <- drm(Biomass_Red.*100 ~ Rate, Cultivar, fct=l3(fixed =c(NA,NA,NA), names = c("slope", "upper", "ed50")), data=POSTchlorethyl)
POSTchlorethylmodel2 <- drm(Biomass_Red.*100 ~ Rate, fct=l3(fixed =c(NA,NA,NA), names = c("slope", "upper", "ed50")), data=POSTchlorethyl)
...
plot(POSTchlorethylmodel2, type="confidence", col=c(1,2), xlab="g ai/ha",#log="", 
     legendPos=c(3.5,50))
ED(POSTchlorethylmodel, c(10, 50, 90), type="absolute", interval ="delta")
```
...
POSTimamodel <- drm(Biomass_Red.*100 ~ Rate, Cultivar, fct=l3(fixed =c(NA,NA,NA), names = c("slope", "upper", "ed50")), data=POSTima)
POSTimamodel2 <- drm(Biomass_Red.*100 ~ Rate, fct=l3(fixed =c(NA,NA,NA), names = c("slope", "upper", "ed50")), data=POSTima)
...
plot(POSTimamodel2, type="confidence", col=c(1,2), xlab="g ai/ha",#log="", 
     legendPos=c(3.5,50))
ED(POSTimamodel, c(10, 50, 90), type="absolute", interval ="delta")
```
...
POSTchlormethylmodel <- drm(Biomass_Red.*100 ~ Rate, Cultivar, fct=l3(fixed =c(NA,NA,NA), names = c("slope", "upper", "ed50")), data=POSTchlormethyl)
POSTchlormethylmodel2 <- drm(Biomass_Red.*100 ~ Rate, fct=l3(fixed =c(NA,NA,NA), names = c("slope", "upper", "ed50")), data=POSTchlormethyl)
...
POSTatrazinemodel <- drm(Biomass_Red.*100 ~ Rate, Cultivar, fct=l3(fixed =c(NA,NA,NA), names = c("slope", "upper", "ed50")), data=POSTatrazine)
POSTatrazinemodel2 <- drm(Biomass_Red.*100 ~ Rate, fct=l3(fixed =c(NA,NA,NA), names = c("slope", "upper", "ed50")), data=POSTatrazine)
...
plot(POSTatrazinemodel2, type="confidence", col=c(1,2), xlab="g ai/ha",#log="", 
     legendPos=c(3.5,50))
ED(POSTatrazinemodel, c(10, 50, 90), type="absolute", interval ="delta")
```
...
POSTfomesafenmodel <- drm(Biomass_Red.*100 ~ Rate, Cultivar, fct=l3(fixed =c(NA,NA,NA), names = c("slope", "upper", "ed50")), data=POSTfomesafen)
POSTfomesafenmodel2 <- drm(Biomass_Red.*100 ~ Rate, fct=l3(fixed =c(NA,NA,NA), names = c("slope", "upper", "ed50")), data=POSTfomesafen)
...
POSTisoxaflutolemodel <- drm(Biomass_Red.*100 ~ Rate, Cultivar, fct=l3(fixed =c(NA,NA,NA), names = c("slope", "upper", "ed50")), data=POSTisoxaflutole)
POSTisoxaflutolemodel2 <- drm(Biomass_Red.*100 ~ Rate, fct=l3(fixed =c(NA,NA,NA), names = c("slope", "upper", "ed50")), data=POSTisoxaflutole)
...
POSTtopramezonemodel <- drm(Biomass_Red.*100 ~ Rate, Cultivar, fct=l3(fixed =c(NA,NA,NA), names = c("slope", "upper", "ed50")), data=POSTtopramezone)
POSTtopramezonemodel2 <- drm(Biomass_Red.*100 ~ Rate, fct=l3(fixed =c(NA,NA,NA), names = c("slope", "upper", "ed50")), data=POSTtopramezone)
...
POSTmesomodel <- drm(Biomass_Red.*100 ~ Rate, Cultivar, fct=l3(fixed =c(NA,NA, NA), names = c("slope", "upper", "ed50")), data=POSTmesotrione)

POSTmesomodel2 <- drm(Biomass_Red.*100 ~ Rate, fct=l3(fixed =c(NA,NA, NA), names = c("slope", "upper", "ed50")), data=POSTmesotrione)
...
plot(POSTmesomodel2, type="confidence", col=c(1,2), xlab="g ai/ha",#log="", 
     legendPos=c(3.5,50))
ED(POSTmesomodel, c(10, 50, 90), type="absolute", interval ="delta")
```
...
POSTtembotrionemodel <- drm(Biomass_Red.*100 ~ Rate, Cultivar, fct=l3(fixed =c(NA,NA,NA), names = c("slope", "upper", "ed50")), data=POSTtembotrione)
POSTtembotrionemodel2 <- drm(Biomass_Red.*100 ~ Rate, fct=l3(fixed =c(NA,NA,NA), names = c("slope", "upper", "ed50")), data=POSTtembotrione)
...
POSTsethoxydimmodel <- drm(Biomass_Red.*100 ~ Rate, Cultivar, fct=l3(fixed =c(NA,NA,NA), names = c("slope", "upper", "ed50")), data=POSTsethoxydim)
POSTsethoxydimmodel2 <- drm(Biomass_Red.*100 ~ Rate, fct=l3(fixed =c(NA,NA,NA), names = c("slope", "upper", "ed50")), data=POSTsethoxydim)
...
POSTclethodimmodel <- drm(Biomass_Red.*100 ~ Rate, Cultivar, fct=W1.3(fixed =c(NA,35,NA), names = c("slope", "upper", "ed50")), data=POSTclethodim)
POSTclethodimmodel2 <- drm(Biomass_Red.*100 ~ Rate, fct=l3(fixed =c(NA,NA,NA), names = c("slope", "upper", "ed50")), data=POSTclethodim)
...
plot(POSTclethodimmodel2, type="confidence", col=c(1,2), xlab="g ai/ha",#log="", 
     legendPos=c(3.5,50))
ED(POSTclethodimmodel, c(10, 50, 90), type="absolute", interval ="delta")
```
...
POSTbromoxynilmodel <- drm(Biomass_Red.*100 ~ Rate, Cultivar, fct=l3(fixed =c(NA,NA,NA), names = c("slope", "upper", "ed50")), data=POSTbromoxynil)
POSTbromoxynilmodel2 <- drm(Biomass_Red.*100 ~ Rate, fct=l3(fixed =c(NA,NA,NA), names = c("slope", "upper", "ed50")), data=POSTbromoxynil)
...
POSTbentazonmodel <- drm(Biomass_Red.*100 ~ Rate, Cultivar, fct=l3(fixed =c(NA,NA,NA), names = c("slope", "upper", "ed50")), data=POSTbentazon)
POSTbentazonmodel2 <- drm(Biomass_Red.*100 ~ Rate, fct=l3(fixed =c(NA,NA,NA), names = c("slope", "upper", "ed50")), data=POSTbentazon)
...
plot(POSTbentazonmodel2, type="confidence", col=c(1,2), xlab="g ai/ha",#log="", 
     legendPos=c(3.5,50))
ED(POSTbentazonmodel, c(10, 50, 90), type="absolute", interval ="delta")
```
...
POSTglyphosatemodel <- drm(Biomass_Red.*100 ~ Rate, Cultivar, fct=l3(fixed =c(NA,NA,NA), names = c("slope", "upper", "ed50")), data=POSTglyphosate)
POSTglyphosatemodel2 <- drm(Biomass_Red.*100 ~ Rate, fct=l3(fixed =c(NA,NA,NA), names = c("slope", "upper", "ed50")), data=POSTglyphosate)
...
POSTglufosinatemodel <- drm(Biomass_Red.*100 ~ Rate, Cultivar, fct=l3(fixed =c(NA,NA,NA), names = c("slope", "upper", "ed50")), data=POSTglufosinate)
POSTglufosinatemodel2 <- drm(Biomass_Red.*100 ~ Rate, fct=l3(fixed =c(NA,NA,NA), names = c("slope", "upper", "ed50")), data=POSTglufosinate)

anova(POSTglufosinatemodel, POSTglufosinatemodel2)

plot(POSTglufosinatemodel, type="average", col=c(1,2), xlab="g ai/ha",#log="", 
     legendPos=c(3.5,50))
ED(POSTglufosinatemodel, c(10, 50, 90), type="absolute", interval ="delta")
```
...
POSTlactofenmodel <- drm(Biomass_Red.*100 ~ Rate, Cultivar, fct=l3(fixed =c(NA,NA,NA), names = c("slope", "upper", "ed50")), data=POSTlactofen)
POSTlactofenmodel2 <- drm(Biomass_Red.*100 ~ Rate, fct=l3(fixed =c(NA,NA,NA), names = c("slope", "upper", "ed50")), data=POSTlactofen)
...
POSTfluthmethylmodel <- drm(Biomass_Red.*100 ~ Rate, Cultivar, fct=l3(fixed =c(NA,NA,NA), names = c("slope", "upper", "ed50")), data=POSTfluthmethyl)
POSTfluthmethylmodel2 <- drm(Biomass_Red.*100 ~ Rate, fct=l3(fixed =c(NA,NA,NA), names = c("slope", "upper", "ed50")), data=POSTfluthmethyl)
...
plot(POSTfluthmethylmodel2, type="confidence", col=c(1,2), xlab="g ai/ha",#log="", 
     legendPos=c(3.5,50))
ED(POSTfluthmethylmodel, c(10, 50, 90), type="absolute", interval ="delta")
```
