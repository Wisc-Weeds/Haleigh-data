...
dicambamodel <- drm(Biomass ~ Rate, Cultivar, fct=l3(fixed =c(NA,NA,NA), names = c("slope", "upper", "ed50")), data=dicamba)
summary(dicambamodel)

# I think your upper limit is not too bad. It is closer to 100. Then you do not need to lock the upper limit.

dicambamodel2 <- drm(Biomass ~ Rate, fct=l3(fixed =c(NA,NA,NA), names = c("slope", "upper", "ed50")), data=dicamba)
summary(dicambamodel2)


anova(dicambamodel, dicambamodel2) # p-value = 0.2196 - You can combine cultivars


plot(dicambamodel, type="confidence", col=c(1,2), xlab="g ae/ha")


plot(dicambamodel2, type="confidence", col=c(1,2), xlab="g ae/ha")

ED(dicambamodel, c(10, 50, 90), type="relative", interval ="delta")
```



```{r message=FALSE, warning=FALSE}
newdata <- expand.grid(Rate=exp(seq(log(0.001), log(2240), by=0.001)))
...
pm <- predict(dicambamodel2, newdata = newdata, interval="confidence")
...
```{r}
ggplot(dicamba, aes(x=Rate0, y=Biomass_Red.*100)) + geom_point(alpha=0.5) + 
                labs(y="Hemp injury (%)", x=expression(bold(paste("Dicamba (g ae"^"-2",")")))) +
                theme_bw() + 
                #coord_trans(x="log") + 
                geom_line(data=newdata, aes(x=Rate, y=p), size=1, color="black") + 
                theme(panel.grid = element_blank(), axis.text = element_text(size=13, color="black"),
                     text = element_text(face="bold", size=16, color="black")) + 
  ggsave("dicambaPRE.png", height = 6, width=6, dpi=600)
```
...
anova(clopyralidmodel, clopyralidmodel2) # con't combine curves
...
ggplot(twofourD, aes(x=Rate0, y=Biomass_Red.*100, color=Cultivar, fill=Cultivar)) + geom_point(stat="identity") + labs(y="", x="g ae/ha", title="2,4-D") +  theme(plot.title = element_text(hjust = 0.5)) + theme_bw() + theme(axis.text=element_text(size=16)) +
  geom_line(data=nd, aes(x=Rate, y=p, color=Cultivar), size=1) + theme(legend.title = element_blank(), text = element_text(size=16, color="black"), plot.title=element_text(hjust = 0.5))+ scale_fill_manual(values = c("#494949", "#c5050c")) + scale_color_manual(values = c("#494949", "#c5050c")) + theme(legend.position = "none") + ggsave("24DPRE.png", height = 6, width=10, dpi=600)
```
...
plot(PRErimmodel2, type="confidence", col=c(1,2), xlab="g ai/ha", #log="", 
     legendPos=c(3.5,50))
ED(PRErimmodel, c(10, 50, 90), type="absolute", interval ="delta")
```
...
pm <- predict(PRErimmodel, newdata = nd, interval="confidence")
...
PRErim$Rate0 <- PRErim$Rate
PRErim$Rate0[PRErim$Rate0==0] <- 0.001
```

```{r}
PRErim$Run<-as.factor(PRErim$Run)
ggplot(PRErim, aes(x=Rate0, y=Biomass_Red.*100, color=Cultivar, fill=Cultivar, lty=Run)) + geom_point(stat="identity") + labs(y="", x="g ai/ha", title="rimsulfuron") +  theme(plot.title = element_text(hjust = 0.5)) + theme_bw() + theme(axis.text=element_text(size=16)) +
  geom_line(data=nd, aes(x=Rate, y=p, color=Cultivar), size=1) + theme(legend.title = element_blank(), text = element_text(size=16, color="black"), plot.title=element_text(hjust = 0.5))+ scale_fill_manual(values = c("#494949", "#c5050c")) + scale_color_manual(values = c("#494949", "#c5050c")) + theme(legend.position = "none") + ggsave("PRErim.png", height = 6, width=10, dpi=600)
```
...
PREchlorethylmodel <- drm(Biomass_Red.*100 ~ Rate, Cultivar, fct=l3(fixed =c(NA,NA,NA), names = c("slope", "upper", "ed50")), data=PREchlorethyl)
summary(PREchlorethylmodel)


PREchlorethylmodel2 <- drm(Biomass_Red.*100 ~ Rate, fct=l3(fixed =c(NA,NA,NA), names = c("slope", "upper", "ed50")), data=PREchlorethyl)
summary(PREchlorethylmodel2)

anova(PREchlorethylmodel, PREchlorethylmodel2)

plot(PREchlorethylmodel, type="all", col=c(1,2), xlab="g ai/ha", #log="", 
     legendPos=c(3.5,50))
...
plot(PREimamodel2, type="confidence", col=c(1,2), xlab="g ai/ha",#log="", 
     legendPos=c(3.5,50))
ED(PREimamodel, c(10, 50, 90), type="absolute", interval ="delta")
```
...
plot(PREatrazinemodel2, type="confidence", col=c(1,2), xlab="g ai/ha",#log="", 
     legendPos=c(3.5,50))
ED(PREatrazinemodel, c(10, 50, 90), type="absolute", interval ="delta")
```
...
plot(PREfomesafenmodel2, type="confidence", col=c(1,2), xlab="g ai/ha",#log="", 
     legendPos=c(3.5,50))
ED(PREfomesafenmodel, c(10, 50, 90), type="absolute", interval ="delta")
```
...
plot(PREisoxaflutolemodel, type="average", col=c(1,2), xlab="g ai/ha",#log="", 
     legendPos=c(3.5,50))
ED(PREisoxaflutolemodel, c(10, 50, 90), type="absolute", interval ="delta")
```
...
plot(PREtopramezonemodel, type="average", col=c(1,2), xlab="g ai/ha",#log="", 
     legendPos=c(3.5,50))
ED(PREtopramezonemodel, c(10, 50, 90), type="absolute", interval ="delta")
```
...
plot(PREtembotrionemodel2, type="confidence", col=c(1,2), xlab="g ai/ha",#log="", 
     legendPos=c(3.5,50))
ED(PREtembotrionemodel, c(10, 50, 90), type="absolute", interval ="delta")
```
...
plot(PREmetribuzinmodel2, type="confidence", col=c(1,2), xlab="g ai/ha",#log="", 
     legendPos=c(3.5,50))
ED(PREmetribuzinmodel, c(10, 50, 90), type="absolute", interval ="delta")
```
...
plot(PREdimethpmodel2, type="confidence", col=c(1,2), xlab="g ai/ha",#log="", 
     legendPos=c(3.5,50))
ED(PREdimethpmodel, c(10, 50, 90), type="absolute", interval ="delta")
```
...
plot(PREacecto1emodel2, type="confidence", col=c(1,2), xlab="g ai/ha",#log="", 
     legendPos=c(3.5,50))
ED(PREacecto1emodel, c(10, 50, 90), type="absolute", interval ="delta")
```
...
plot(PREacecto2model2, type="confidence", col=c(1,2), xlab="g ai/ha",#log="", 
     legendPos=c(3.5,50))
ED(PREacecto2model, c(10, 50, 90), type="absolute", interval ="delta")
```
